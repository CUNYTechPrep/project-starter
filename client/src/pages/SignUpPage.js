...
class SignUpPage extends React.Component {
  ...
  signup = (e) => {
    e.preventDefault();
    let { firstName, lastName, email, password, age, gender, fitLevel, height, weight, bio } = this.state;
    auth.register(firstName, lastName, email, password, age, gender, fitLevel, height, weight, bio) //we created an auth function called register
      .then((user) => {
