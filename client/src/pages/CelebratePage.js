    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="col-xl-10 col-lg-9 col-md-8 ml-auto py-2 mt-5 shadow-lg">
                    <h3>It's D-Day</h3>
                    <iframe title="Grinch Smile" src="https://giphy.com/embed/x7gjmBuaHrWak" width="325" height="480" frameBorder="0" className="giphy-embed" allowFullScreen></iframe>
                </div>
                ...
                <div className="col-xl-10 col-lg-9 col-md-8 ml-auto bg-dark py-2 mt-5 shadow-lg">
                    ...
                    <iframe title="Thanksgiving" src="https://giphy.com/embed/R1bq4ZgEyvAjK" width="480" height="480" frameBorder="0" className="giphy-embed" allowFullScreen></iframe>
                </div>
