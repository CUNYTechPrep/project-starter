...
function ThreadPost({id, content, title, createdAt, updatedAt, forumId, threadId, authorId}) {
  
    return (
      <div>
        <p className="post-date">Posted on: {createdAt} 02-13-2021 9:20am</p>
        <article className="each-post">
          <div>
            ...
            <div>
              <p>
                <b>{title}Best ways to Bulk while cutting?</b>
                <br></br>
                <br></br>
                {content}
              ...
              <p className="post-last-edited-date">
                <i>Last edited on: {updatedAt}02-13-2021 9:20am</i>
              </p>
            </div>
          </div>
        </article>
