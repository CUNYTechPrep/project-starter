    ...
    return (
      <div>
        <h6 className='thread-heading'>
          <b>Thread: </b>
          <text className='thread-topic'>{this.state.originalTitle}</text>
        </h6>
        <div>
          {auth.isAuthenticated ? (
            <div className='post'>
              <h2 className='postTitle font-weight-bold'>Add a FitPost!</h2>

              <div style={{ paddingTop: 20 }}>
                <form onSubmit={this.postPostinThread}>
                  ...
                  <br></br>
                  <button
                    className='post-button btn my-10 font-weight-bold'
                    type='submit'
                  >
                    Save Post
                  </button>
            ...
            <Link
              to='/sign-in'
              className='post-login-button btn my-10 font-weight-bold'
            >
