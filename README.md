...
- PostgreSQL User/Role
  - name: `abodem_user`
  - password: `abodem_pass`
- PostgreSQL Database
  - name: `ctp_abodedb_development`

#### For Windows/pgAdmin users

If you are on Windows and installed **pgAdmin** follow our [pgAdmin guide](https://github.com/CUNYTechPrep/guides/blob/master/pgAdmin-create-user-db.md) to create a user in PostgreSQL named `abodem_user` with the password `abodem_pass` and a database named `ctp_abodedb_development`.
