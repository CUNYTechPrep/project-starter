...
```
createdb -h localhost -U ctp_user trippin
```

> You will create a DB for each project you start based on this repo. For other projects change `app2019_development` to the new apps database name. For Trippin, we will use trippin
