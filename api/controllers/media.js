...
//   });
/////////////////////////////////////////////////////////////////////////////////////////
router.post("/shows/:title", async (req, res) => { // create a new Media  /// this should be in rating post
  const { title } = req.params;   // 
  try {
...
router.post("/mediaId/ratings", async (req, res) => { // create rating and update avg
